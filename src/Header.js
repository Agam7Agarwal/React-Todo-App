    ...
    render(){
        return(
            ...
            <div>
                    ...
                    <div className="container-fluid">
                        ...
                        <ul className="nav navbar-nav navbar-right">
                            ...
                            {this.state.isUserLogIn ?
                                <li onClick={this.logoutclick}><Link to="/"><span className="glyphicon glyphicon-log-out"> </span>Logout</Link></li> :
                                <span/>
                            }
                        </ul>
                    </div>
                ...
                <Route path="/Login"  render={props => (< Login{...props} logindetails={this.logindetails} />)}/>
